...
CREATE DATABASE chatalytics;
# Quit out
\q
```

The above creates the actual database that will be used for this application and the name of the database is `chatalytics` which you can change, but make sure to change the .env and in your production app accordingly which I will talk about lower in this guide.
...
export DATABASE_URL=postgresql://localhost/chatalytics
````
...
# Enter postgres command line interface
$ psql
# Create your database which I will call chatalytics in this example, but you can change accordingly
CREATE DATABASE chatalytics;
# Quit out
\q
```
